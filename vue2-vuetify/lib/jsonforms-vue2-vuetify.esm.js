...
import { VLabel, VBadge, VTooltip, VIcon, VList, VListItemGroup, VListItem, VListItemTitle, VListItemContent, VListItemAction, VListItemAvatar, VAvatar, VRow, VCol, VToolbar, VToolbarTitle, VBtn, VSpacer, VExpansionPanels, VExpansionPanel, VExpansionPanelHeader, VExpansionPanelContent, VContainer, VVirtualScroll, VCard, VCardActions, VCardTitle, VCardText, VDialog, VTabs, VTab, VTabsItems, VTabItem, VStepper, VStepperHeader, VStepperStep, VDivider, VStepperItems, VStepperContent, VTextField, VHover, VSimpleTable, VCheckbox, VSelect, VCombobox, VSwitch, VMenu, VDatePicker, VTimePicker, VTextarea, VRadioGroup, VRadio, VSlider, VAutocomplete } from 'vuetify/lib';
...
import { VueMaskDirective, VueMaskPlugin } from 'v-mask';
...
var controlRenderer$r = defineComponent({
  ...
  props: _objectSpread2({}, rendererProps()),
  setup: function setup(props) {
    var selectedIndex = ref(undefined);
    var t = useTranslator();
    return _objectSpread2(_objectSpread2({}, useVuetifyArrayControl(useJsonFormsArrayControl(props))), {}, {
  ...
  computed: {
    ...
    foundUISchema: function foundUISchema() {
      return findUISchema(this.control.uischemas, this.control.schema, this.control.uischema.scope, this.control.path, undefined, this.control.uischema);
    },
...
var controlRenderer$q = defineComponent({
...
var layoutRenderer$4 = defineComponent({
...
var categorizationStepperTester = and(uiTypeIs('Categorization'), categorizationHasCategory, optionIs('variant', 'stepper'));
var entry$t = {
...
var script$1 = defineComponent({
  ...
  setup: function setup(props) {
    ...
    var additionalKeys = control.value.data && isPlainObject(control.value.data) ? Object.keys(control.value.data).filter(function (k) {
        ...
        if (this.control.data && _typeof(this.control.data) === 'object') {
          ...
          this.additionalPropertyItems.forEach(function (ap) {
            if (ap.schema && (!keys.includes(ap.propertyName) || newData[ap.propertyName] === undefined || newData[ap.propertyName] === null && ap.schema.type !== 'null')
              ...
              var newValue = createDefaultValue(ap.schema);
    ...
    addProperty: function addProperty() {
      if (this.newPropertyName) {
        ...
        if (this.control.data && _typeof(this.control.data) === 'object' && additionalProperty.schema) {
          this.control.data[this.newPropertyName] = createDefaultValue(additionalProperty.schema);
...
var controlRenderer$n = defineComponent({
  ...
  methods: {
    ...
    title: function title(prop) {
      ...
      return (_this$control$schema$ = (_this$control$schema$2 = this.control.schema.properties) === null || _this$control$schema$2 === void 0 || (_this$control$schema$2 = _this$control$schema$2[prop]) === null || _this$control$schema$2 === void 0 ? void 0 : _this$control$schema$2.title) !== null && _this$control$schema$ !== void 0 ? _this$control$schema$ : startCase(prop);
    },
...
var controlRenderer$k = defineComponent({
  ...
  methods: {
    ...
    newSelection: function newSelection() {
      this.handleChange(this.path, this.newSelectedIndex !== undefined && this.newSelectedIndex !== null ? createDefaultValue(this.indexedOneOfRenderInfos[this.newSelectedIndex].schema) : {});
...
var controlRenderer$j = defineComponent({
  ...
  methods: {
    ...
    openNewTab: function openNewTab() {
      this.handleChange(this.path, createDefaultValue(this.oneOfRenderInfos[this.newSelectedIndex].schema));
...
var controlRenderer$h = defineComponent({
  ...
  props: _objectSpread2({}, rendererProps()),
  setup: function setup(props) {
    return useVuetifyControl(useJsonFormsControl(props), function (newValue) {
        ...
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          ...
          if (part == 'YYYY') {
            ...
            for (var position = 0; position <= 2; position++) {
              var regex = undefined;
              for (var i = 0; i <= 11; i++) {
                var month = dayjs().month(i).format('MMM');
            ...
            for (var _i = 0; _i <= 11; _i++) {
              var _month = dayjs().month(_i).format('MMMM');
              months.push(_month);
...
var hasOption = function hasOption(optionName) {
  return function (uischema) {
    ...
    return options && !isEmpty(options) && typeof options[optionName] === 'string' || false;
  };
};
var entry$3 = {
...
export { __vue_component__$q as AllOfRenderer, __vue_component__$p as AnyOfRenderer, __vue_component__$i as AnyOfStringOrEnumControlRenderer, __vue_component__$o as ArrayControlRenderer, __vue_component__$y as ArrayLayoutRenderer, __vue_component__$1 as AutocompleteEnumControlRenderer, __vue_component__ as AutocompleteOneOfEnumControlRenderer, __vue_component__$h as BooleanControlRenderer, __vue_component__$g as BooleanToggleControlRenderer, __vue_component__$x as CategorizationRenderer, __vue_component__$w as CategorizationStepperRenderer, __vue_component__$j as ControlWrapper, __vue_component__$f as DateControlRenderer, __vue_component__$e as DateTimeControlRenderer, DisabledIconFocus, __vue_component__$n as EnumArrayRenderer, __vue_component__$d as EnumControlRenderer, __vue_component__$v as GroupRenderer, __vue_component__$u as HorizontalLayoutRenderer, __vue_component__$c as IntegerControlRenderer, __vue_component__$C as LabelRenderer, __vue_component__$z as ListWithDetailRenderer, __vue_component__$b as MultiStringControlRenderer, __vue_component__$a as NumberControlRenderer, __vue_component__$m as ObjectRenderer, __vue_component__$9 as OneOfEnumControlRenderer, __vue_component__$8 as OneOfRadioGroupControlRenderer, __vue_component__$l as OneOfRenderer, __vue_component__$k as OneOfTabRenderer, __vue_component__$7 as PasswordControlRenderer, __vue_component__$6 as RadioGroupControlRenderer, __vue_component__$5 as SliderControlRenderer, __vue_component__$4 as StringControlRenderer, __vue_component__$3 as StringMaskControlRenderer, __vue_component__$2 as TimeControlRenderer, __vue_component__$B as ValidationBadge, __vue_component__$A as ValidationIcon, __vue_component__$t as VerticalLayoutRenderer, additionalRenderers, entry$v as arrayLayoutRendererEntry, arrayListRendererEntry, arrayRenderers, entry$u as categorizationRendererEntry, entry$t as categorizationStepperRendererEntry, classes, complexRenderers, controlRenderers, createAjv, defaultStyles, extendedRenderers, extendedVuetifyRenderers, entry$s as groupRendererEntry, entry$r as horizontalLayoutRendererEntry, i18nDefaultMessages, layoutRenderers, mergeStyles, parseDateTime, useAjv, useComputedLabel, useControlAppliedOptions, useNested, useStyles, useTranslator, useVuetifyArrayControl, useVuetifyBasicControl, useVuetifyControl, useVuetifyLabel, useVuetifyLayout, useVuetifyProps, entry$q as verticalLayoutRendererEntry, vuetifyRenderers };
//# sourceMappingURL=jsonforms-vue2-vuetify.esm.js.map
